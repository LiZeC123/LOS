...
void syscall_init(void) {
  ...
  syscall_table[SYS_WAITPID] = NULL;
  syscall_table[SYS_CREAT] = NULL;
  syscall_table[SYS_LINK] = NULL;
  syscall_table[SYS_UNLINK] = sys_unlink;
  syscall_table[SYS_EXECVE] = NULL;

  syscall_table[SYS_LSEEK] = sys_lseek;
  syscall_table[SYS_GETPID] = sys_getpid;

  syscall_table[SYS_MOUNT] = NULL;
  syscall_table[SYS_UMOUNT] = NULL;

...
# 创建内核
kernel.bin: main.o kernel.o console.o sync.o keyboard.o interrupt.o thread.o time.o switch.o list.o memory.o bitmap.o ioqueue.o string.o debug.o print2.o print.o 
